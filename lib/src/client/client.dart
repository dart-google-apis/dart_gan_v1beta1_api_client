...
abstract class Client extends ClientBase {
  core.String basePath = "/gan/v1beta1/";
  ...
  AdvertisersResource_ get advertisers => new AdvertisersResource_(this);
  CcOffersResource_ get ccOffers => new CcOffersResource_(this);
  EventsResource_ get events => new EventsResource_(this);
  LinksResource_ get links => new LinksResource_(this);
  PublishersResource_ get publishers => new PublishersResource_(this);
